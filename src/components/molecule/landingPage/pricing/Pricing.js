...
const PricingPlan = () => {
    return (
        <div
            id="pricing"
            className="flex flex-col md:bg-pricingPageBg  bg-no-repeat bg-cover mx-auto justify-around items-center p-5 rounded-xl relative"
        >
            <h4 className="font-semibold mb-2">Pricing</h4>
            <h2 className="text-3xl text-center md:text-left font-bold mb-20 ">
            ...
            <div className="flex md:flex-row flex-col justify-start items-center  ">
                ...
                <div className=" border-[#F2F2F2] bg-white min-w-80 p-10 flex flex-col justify-start items-center shadow-2xl  ">
                    ...
                    <ul className="self-start mb-4 ">
                        <li className="flex gap-2 md:gap-5 mb-3   items-center">
                    ...
                    <Link to="/login">
                        <button
                            type="button"
                            className="md:py-3 py-3  px-4 md:px-5 text-xl text-white rounded-full bg-gradient-to-r from-cyan-500 to-[#459EFF] "
                        >
                            Make Resume
                        </button>
                    </Link>
                ...
                {/* Paid Plan */}
                <div className="relative bg-gradient-to-tr from-bgPurple to-bgPink rounded-lg mx-auto md:mx-0 md:-ml-5  min-w-96 p-10 flex flex-col justify-start items-center mb-3 overflow-x-hidden overflow-y-hidden shadow-2xl ">
                    ...
                    <ul className="self-start mb-4 z-10">
                        <li className="flex gap-2 md:gap-5 mb-8 items-center">
                            <img src={tick} alt="" />
